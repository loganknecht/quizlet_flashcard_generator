...
# Variable Assignment
echo "Executing: 'docker build $REPOSITORY_ROOT_DIRECTORY -f $REPOSITORY_ROOT_DIRECTORY/docker/Dockerfile -t $DOCKER_IMAGE_TAG'"
docker build $REPOSITORY_ROOT_DIRECTORY -f $REPOSITORY_ROOT_DIRECTORY/docker/Dockerfile -t $DOCKER_IMAGE_TAG